      ...
      <section className={`px-[6%] py-[90px] ${dark ? 'bg-[#080618]' : 'bg-gray-50'}`}>
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-14">
            ...
            <p className={`max-w-[540px] mx-auto leading-relaxed text-base ${dark ? 'text-[#6b688a]' : 'text-gray-600'}`}>Discover the innovative software products developed at UNIVEONS.</p>
          </div>
...
<div className="flex flex-wrap gap-2 mb-4">
                ...
                <button className="px-3 py-1.5 rounded-full text-xs font-medium bg-green-600 text-white hover:bg-green-700 flex items-center gap-1">
